...
internal sealed class SaIrisCellsProcessor : IVideoEffectProcessor {
 readonly SaIrisCellsEffect item; readonly SaIrisCellsShader shader; readonly ID2D1Image output;
 public SaIrisCellsProcessor(IGraphicsDevicesAndContext devices, SaIrisCellsEffect item) {
  this.item=item;shader=new SaIrisCellsShader(devices);
