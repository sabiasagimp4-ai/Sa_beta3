...
internal sealed class SaPetalGraftProcessor : IVideoEffectProcessor {
 readonly SaPetalGraftEffect item; readonly SaPetalGraftShader shader; readonly ID2D1Image output;
 public SaPetalGraftProcessor(IGraphicsDevicesAndContext devices, SaPetalGraftEffect item) {
  this.item=item;shader=new SaPetalGraftShader(devices);
