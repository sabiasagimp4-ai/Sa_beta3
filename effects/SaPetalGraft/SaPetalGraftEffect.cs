...
namespace SaPetalGraft;
[VideoEffect("花弁の接ぎ木", ["フィルタ"], ["構造", "色"], IsAviUtlSupported=false)]
public sealed class SaPetalGraftEffect : VideoEffectBase {
 public override string Label => "花弁の接ぎ木";
 [Display(Name="強さ", Description="原画と処理結果の混合率", Order=0)]
 [AnimationSlider("F1", "%", 0, 100)]
 public Animation Strength {get;} = new(68,0,100);
 ...
 public Animation Size {get;} = new(30,2,128);
 [Display(Name="しきい値", Description="小さい色差による反応を滑らかに抑える", Order=3)]
 [AnimationSlider("F0", "", 0, 255)]
 public Animation Threshold {get;} = new(12,0,255);
 ...
 public override IVideoEffectProcessor CreateVideoEffect(IGraphicsDevicesAndContext devices) => new SaPetalGraftProcessor(devices,this);
