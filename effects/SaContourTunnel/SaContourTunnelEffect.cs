...
[VideoEffect("輪郭の空洞化", ["フィルタ"], ["構造", "色"], IsAviUtlSupported=false)]
public sealed class SaContourTunnelEffect : VideoEffectBase {
 public override string Label => "輪郭の空洞化";
 [Display(Name="強さ", Description="原画と処理結果の混合率", Order=0)]
 [AnimationSlider("F1", "%", 0, 100)]
 public Animation Strength {get;} = new(82,0,100);
 ...
 [Display(Name="層の幅", Description="構造の空間的な大きさ", Order=2)]
 [AnimationSlider("F1", "px", 4, 192)]
 public Animation Size {get;} = new(24,4,192);
 ...
 public Animation Color {get;} = new(28,-180,180);
 ...
 public override IVideoEffectProcessor CreateVideoEffect(IGraphicsDevicesAndContext devices) => new SaContourTunnelProcessor(devices,this);
