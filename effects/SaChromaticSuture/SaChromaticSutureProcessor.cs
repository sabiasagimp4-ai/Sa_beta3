...
internal sealed class SaChromaticSutureProcessor : IVideoEffectProcessor {
 readonly SaChromaticSutureEffect item; readonly SaChromaticSutureShader shader; readonly ID2D1Image output;
 public SaChromaticSutureProcessor(IGraphicsDevicesAndContext devices, SaChromaticSutureEffect item) {
  this.item=item;shader=new SaChromaticSutureShader(devices);
