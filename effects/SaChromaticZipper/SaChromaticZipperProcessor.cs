...
internal sealed class SaChromaticZipperProcessor : IVideoEffectProcessor {
 readonly SaChromaticZipperEffect item; readonly SaChromaticZipperShader shader; readonly ID2D1Image output;
 public SaChromaticZipperProcessor(IGraphicsDevicesAndContext devices, SaChromaticZipperEffect item) {
  this.item=item;shader=new SaChromaticZipperShader(devices);
