...
namespace SaChromaticZipper;
[VideoEffect("色の噛み合わせ", ["フィルタ"], ["構造", "色"], IsAviUtlSupported=false)]
public sealed class SaChromaticZipperEffect : VideoEffectBase {
 public override string Label => "色の噛み合わせ";
 [Display(Name="強さ", Description="原画と処理結果の混合率", Order=0)]
 [AnimationSlider("F1", "%", 0, 100)]
 public Animation Strength {get;} = new(78,0,100);
 [Display(Name="変化範囲", Description="色を探す・変形させる距離", Order=1)]
 [AnimationSlider("F1", "px", 0, 256)]
 public Animation Radius {get;} = new(42,0,256);
 [Display(Name="模様の幅", Description="構造の繰り返し幅", Order=2)]
 [AnimationSlider("F1", "px", 2, 128)]
 public Animation Size {get;} = new(20,2,128);
 ...
 public override IVideoEffectProcessor CreateVideoEffect(IGraphicsDevicesAndContext devices) => new SaChromaticZipperProcessor(devices,this);
