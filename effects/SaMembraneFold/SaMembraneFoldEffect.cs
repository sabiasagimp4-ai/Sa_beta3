...
namespace SaMembraneFold;
[VideoEffect("膜の折り返し", ["フィルタ"], ["構造", "色"], IsAviUtlSupported=false)]
public sealed class SaMembraneFoldEffect : VideoEffectBase {
 public override string Label => "膜の折り返し";
 [Display(Name="強さ", Description="原画と処理結果の混合率", Order=0)]
 [AnimationSlider("F1", "%", 0, 100)]
 public Animation Strength {get;} = new(76,0,100);
 [Display(Name="変化範囲", Description="色を探す・変形させる距離", Order=1)]
 [AnimationSlider("F1", "px", 0, 256)]
 public Animation Radius {get;} = new(46,0,256);
 [Display(Name="模様の幅", Description="構造の繰り返し幅", Order=2)]
 [AnimationSlider("F1", "px", 2, 128)]
 public Animation Size {get;} = new(28,2,128);
 ...
 public Animation Iterations {get;} = new(16,1,16);
 [Display(Name="色相変化", Description="構造が変化した部分の色相回転", Order=5)]
 [AnimationSlider("F1", "°", -180, 180)]
 public Animation Color {get;} = new(26,-180,180);
 ...
 public override IVideoEffectProcessor CreateVideoEffect(IGraphicsDevicesAndContext devices) => new SaMembraneFoldProcessor(devices,this);
