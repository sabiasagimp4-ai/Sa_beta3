...
internal sealed class SaMembraneFoldProcessor : IVideoEffectProcessor {
 readonly SaMembraneFoldEffect item; readonly SaMembraneFoldShader shader; readonly ID2D1Image output;
 public SaMembraneFoldProcessor(IGraphicsDevicesAndContext devices, SaMembraneFoldEffect item) {
  this.item=item;shader=new SaMembraneFoldShader(devices);
