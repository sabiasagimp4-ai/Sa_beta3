...
internal sealed class SaFacetBloomProcessor : IVideoEffectProcessor {
 readonly SaFacetBloomEffect item; readonly SaFacetBloomShader shader; readonly ID2D1Image output;
 public SaFacetBloomProcessor(IGraphicsDevicesAndContext devices, SaFacetBloomEffect item) {
  this.item=item;shader=new SaFacetBloomShader(devices);
