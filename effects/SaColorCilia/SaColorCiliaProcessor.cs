...
internal sealed class SaColorCiliaProcessor : IVideoEffectProcessor {
 readonly SaColorCiliaEffect item; readonly SaColorCiliaShader shader; readonly ID2D1Image output;
 public SaColorCiliaProcessor(IGraphicsDevicesAndContext devices, SaColorCiliaEffect item) {
  this.item=item;shader=new SaColorCiliaShader(devices);
