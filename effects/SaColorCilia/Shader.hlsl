...
#ifndef BASELINE
 if(t.x==0.0f&&t.y==0.0f){float4 z=cleanAt(b);Pixel v;v.r=z.r;v.g=z.g;v.b=z.b;v.a=z.a;return v;}
#endif
 float4 c=lerp(lerp(cleanAt(b),cleanAt(b+float2(1,0)),t.x),lerp(cleanAt(b+float2(0,1)),cleanAt(b+float2(1,1)),t.x),t.y);
