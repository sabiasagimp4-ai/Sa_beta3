...
namespace SaPigmentRelay;
[VideoEffect("顔料の競合", ["フィルタ"], ["構造", "色"], IsAviUtlSupported=false)]
public sealed class SaPigmentRelayEffect : VideoEffectBase {
 public override string Label => "顔料の競合";
 [Display(Name="強さ", Description="原画と処理結果の混合率", Order=0)]
 [AnimationSlider("F1", "%", 0, 100)]
 public Animation Strength {get;} = new(70,0,100);
 [Display(Name="変化範囲", Description="色を探す・変形させる距離", Order=1)]
 [AnimationSlider("F1", "px", 0, 256)]
 public Animation Radius {get;} = new(34,0,256);
 ...
 public Animation Threshold {get;} = new(14,0,255);
 ...
 public Animation Color {get;} = new(30,-180,180);
 [Display(Name="配置シード", Description="配置を固定する整数。変更すると模様が切り替わる", Order=6)]
 [AnimationSlider("F0", "", 0, 65535)]
 public Animation Seed {get;} = new(17,0,65535);
 public override IEnumerable<string> CreateExoVideoFilters(int keyFrameIndex, ExoOutputDescription exoOutputDescription) => [];
 public override IVideoEffectProcessor CreateVideoEffect(IGraphicsDevicesAndContext devices) => new SaPigmentRelayProcessor(devices,this);
