...
internal sealed class SaPigmentRelayProcessor : IVideoEffectProcessor {
 readonly SaPigmentRelayEffect item; readonly SaPigmentRelayShader shader; readonly ID2D1Image output;
 public SaPigmentRelayProcessor(IGraphicsDevicesAndContext devices, SaPigmentRelayEffect item) {
  this.item=item;shader=new SaPigmentRelayShader(devices);
